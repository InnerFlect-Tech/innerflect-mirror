...
/**
 * Forge Shop — registered in `lib/design/ecosystem.ts` as `/shops/forge` and pointed
 ...
 */
const shop = SHOPS.forge;

export const metadata: Metadata = {
  title: 'Forge Shop · Innerflect',
  description: shop.pulse,
};

export default function Page() {
  return (
    <main data-surface="shop-forge">
      <PublicNav current="/shops/forge" />
