...
export const domains: Domain[] = [
  defineDomain({
    ...
    workflows: [
      ...
      { id: 'mk-segment', name: 'Audience segmentation', throughput: 88, autonomy: 85, humans: 0, state: 'healthy' },
      { id: 'mk-attrib', name: 'Campaign attribution', throughput: 52, autonomy: 58, humans: 0, state: 'healthy' },
      { id: 'mk-content', name: 'Content publishing', throughput: 46, autonomy: 70, humans: 1, state: 'healthy' },
      { id: 'mk-message', name: 'Message testing', throughput: 34, autonomy: 64, humans: 1, state: 'healthy' },
      { id: 'mk-compete', name: 'Competitor watch', throughput: 28, autonomy: 88, humans: 0, state: 'healthy' },
    ],
    agents: [
  ...
  defineDomain({
    ...
    workflows: [
      ...
      { id: 'sl-hygiene', name: 'Pipeline hygiene', throughput: 96, autonomy: 90, humans: 0, state: 'healthy' },
      { id: 'sl-schedule', name: 'Discovery scheduling', throughput: 64, autonomy: 82, humans: 0, state: 'healthy' },
      { id: 'sl-proposal', name: 'Proposal drafting', throughput: 38, autonomy: 61, humans: 1, state: 'healthy' },
      { id: 'sl-handover', name: 'Handover to delivery', throughput: 26, autonomy: 72, humans: 1, state: 'healthy' },
      { id: 'sl-pricing', name: 'Pricing approval', throughput: 22, autonomy: 40, humans: 1, state: 'healthy' },
      { id: 'sl-winloss', name: 'Win/loss capture', throughput: 18, autonomy: 66, humans: 0, state: 'healthy' },
      { id: 'sl-redlines', name: 'Contract redlines', throughput: 14, autonomy: 35, humans: 1, state: 'healthy' },
    ],
    agents: [
  ...
  defineDomain({
    ...
    workflows: [
      { id: 'dl-build', name: 'Build execution', throughput: 62, autonomy: 58, humans: 2, state: 'healthy' },
      { id: 'dl-comms', name: 'Client comms', throughput: 58, autonomy: 70, humans: 0, state: 'healthy' },
      { id: 'dl-verify', name: 'Artefact verification', throughput: 44, autonomy: 80, humans: 0, state: 'active' },
      { id: 'dl-envs', name: 'Environment provisioning', throughput: 30, autonomy: 86, humans: 0, state: 'healthy' },
      { id: 'dl-kickoff', name: 'Kickoff packaging', throughput: 24, autonomy: 74, humans: 0, state: 'healthy' },
      { id: 'dl-handover', name: 'Handover docs', throughput: 21, autonomy: 64, humans: 0, state: 'healthy' },
      { id: 'dl-scope', name: 'Scope baselining', throughput: 18, autonomy: 52, humans: 1, state: 'healthy' },
      { id: 'dl-change', name: 'Change requests', throughput: 16, autonomy: 45, humans: 1, state: 'healthy' },
      { id: 'dl-retro', name: 'Retro capture', throughput: 14, autonomy: 76, humans: 0, state: 'healthy' },
      { id: 'dl-gate1', name: 'Gate 1 review', throughput: 12, autonomy: 30, humans: 1, state: 'attention' },
      { id: 'dl-signoff', name: 'Acceptance sign-off', throughput: 11, autonomy: 42, humans: 0, state: 'healthy' },
      { id: 'dl-incident', name: 'Incident response', throughput: 9, autonomy: 55, humans: 0, state: 'healthy' },
    ],
    agents: [
  ...
  defineDomain({
    ...
    workflows: [
      ...
      { id: 'fn-expense', name: 'Expense capture', throughput: 74, autonomy: 88, humans: 0, state: 'healthy' },
      { id: 'fn-invoice', name: 'Invoice issue', throughput: 48, autonomy: 76, humans: 0, state: 'healthy' },
      { id: 'fn-vendor', name: 'Vendor payments', throughput: 40, autonomy: 78, humans: 0, state: 'healthy' },
      { id: 'fn-dunning', name: 'Dunning', throughput: 34, autonomy: 70, humans: 0, state: 'healthy' },
      { id: 'fn-revrec', name: 'Revenue recognition', throughput: 26, autonomy: 48, humans: 1, state: 'attention' },
      { id: 'fn-forecast', name: 'Cash forecasting', throughput: 20, autonomy: 60, humans: 0, state: 'healthy' },
      { id: 'fn-margin', name: 'Margin analysis', throughput: 15, autonomy: 56, humans: 0, state: 'healthy' },
      { id: 'fn-tax', name: 'Tax filing prep', throughput: 8, autonomy: 34, humans: 0, state: 'healthy' },
