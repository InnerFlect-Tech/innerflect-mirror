...
export const ECOSYSTEM_PAGES: readonly EcosystemPage[] = [
  ...
  { id: 'os-shop', name: 'OS Shop', surface: 'os-shop', group: 'build', href: '/shops/os', file: 'app/shops/os/page.tsx', access: 'public', purpose: 'Patterns, playbooks and operating-system architectures. The route renders the real catalogue; checkout is not built, so the node stays building.', state: 'live' },
  { id: 'forge-shop', name: 'Forge Shop', surface: 'forge-shop', group: 'build', href: '/shops/forge', file: 'app/shops/forge/page.tsx', access: 'public', purpose: 'Reusable open components and gated proprietary capabilities. The route renders the real catalogue; checkout is not built, so the node stays building.', state: 'live' },
